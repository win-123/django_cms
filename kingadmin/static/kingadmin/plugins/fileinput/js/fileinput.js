...
(function (factory) {
    ...
    tImage = '<imgs src="{data}" class="kv-preview-data file-preview-image" title="{caption}" alt="{caption}" ' +
        STYLE_SETTING + '>\n';
    ...
    FileInput.prototype = {
        ...
        _clearObjects: function ($el) {
            ...
            $el.find('imgs object div').each(function () {
                $(this).remove();
            });
        },
        ...
        clear: function () {
            var self = this, cap;
            self.$btnUpload.removeAttr('disabled');
            self._getThumbs().find('video,audio,imgs').each(function () {
                cleanMemory($(this));
            });
            self._resetUpload();
            self.clearStack();
